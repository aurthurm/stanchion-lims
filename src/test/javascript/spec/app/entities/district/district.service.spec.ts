...
describe('Service Tests', () => {
  describe('District Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new District(123, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a District', async () => {
      ...
      it('should not update a District', async () => {
      ...
      it('should not partial update a District', async () => {
      ...
      it('should not return a list of District', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a District', async () => {
