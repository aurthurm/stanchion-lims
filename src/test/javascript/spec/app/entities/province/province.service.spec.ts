...
describe('Service Tests', () => {
  describe('Province Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Province(123, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Province', async () => {
      ...
      it('should not update a Province', async () => {
      ...
      it('should not partial update a Province', async () => {
      ...
      it('should not return a list of Province', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Province', async () => {
