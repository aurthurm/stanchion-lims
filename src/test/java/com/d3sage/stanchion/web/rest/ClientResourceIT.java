...
import com.d3sage.stanchion.repository.ClientRepository;
import com.d3sage.stanchion.service.dto.ClientDTO;
import com.d3sage.stanchion.service.mapper.ClientMapper;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().name(DEFAULT_NAME);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().name(UPDATED_NAME);
        return client;
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME);
