...
class PatientResourceIT {
    ...
    public static Patient createEntity(EntityManager em) {
        Patient patient = new Patient().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME);
        return patient;
    }
    ...
    public static Patient createUpdatedEntity(EntityManager em) {
        Patient patient = new Patient().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
        return patient;
    }
    ...
    void putNewPatient() throws Exception {
        ...
        updatedPatient.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
    ...
    void partialUpdatePatientWithPatch() throws Exception {
        ...
        partialUpdatedPatient.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
