  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="stanchionApp.task.home.createOrEditLabel"
          data-cy="TaskCreateUpdateHeading"
          v-text="$t('stanchionApp.task.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.task.title')" for="task-title">Title</label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.task.description')" for="task-description">Description</label>
            <input
              type="text"
              class="form-control"
              name="description"
