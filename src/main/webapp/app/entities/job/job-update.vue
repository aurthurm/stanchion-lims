  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="stanchionApp.job.home.createOrEditLabel"
          data-cy="JobCreateUpdateHeading"
          v-text="$t('stanchionApp.job.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.job.jobTitle')" for="job-jobTitle">Job Title</label>
            <input
              type="text"
              class="form-control"
              name="jobTitle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.job.minSalary')" for="job-minSalary">Min Salary</label>
            <input
              type="number"
              class="form-control"
              name="minSalary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.job.maxSalary')" for="job-maxSalary">Max Salary</label>
            <input
              type="number"
              class="form-control"
              name="maxSalary"
          ...
          <div class="form-group">
            <label v-text="$t('stanchionApp.job.task')" for="job-task">Task</label>
            <select
              class="form-control"
              id="job-tasks"
              data-cy="task"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.job.employee')" for="job-employee">Employee</label>
