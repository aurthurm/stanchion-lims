    ...
    <div class="col-8">
      <div v-if="job">
        <h2 class="jh-entity-heading" data-cy="jobDetailsHeading">
          <span v-text="$t('stanchionApp.job.detail.title')">Job</span> {{ job.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('stanchionApp.job.jobTitle')">Job Title</span>
          </dt>
          <dd>
            <span>{{ job.jobTitle }}</span>
          </dd>
          <dt>
            <span v-text="$t('stanchionApp.job.minSalary')">Min Salary</span>
          </dt>
          <dd>
            <span>{{ job.minSalary }}</span>
          </dd>
          <dt>
            <span v-text="$t('stanchionApp.job.maxSalary')">Max Salary</span>
          </dt>
          <dd>
            <span>{{ job.maxSalary }}</span>
          </dd>
          <dt>
            <span v-text="$t('stanchionApp.job.task')">Task</span>
          </dt>
          <dd>
          ...
          <dt>
            <span v-text="$t('stanchionApp.job.employee')">Employee</span>
          </dt>
          <dd>
