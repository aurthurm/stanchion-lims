    ...
    <div class="col-8">
      <div v-if="province">
        <h2 class="jh-entity-heading" data-cy="provinceDetailsHeading">
          <span v-text="$t('stanchionApp.province.detail.title')">Province</span> {{ province.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('stanchionApp.province.name')">Name</span>
          </dt>
          <dd>
            <span>{{ province.name }}</span>
          </dd>
          <dt>
            <span v-text="$t('stanchionApp.province.district')">District</span>
          </dt>
          <dd>
...
<script lang="ts" src="./province-details.component.ts"></script>
