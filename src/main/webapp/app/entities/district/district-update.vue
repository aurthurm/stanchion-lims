  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="stanchionApp.district.home.createOrEditLabel"
          data-cy="DistrictCreateUpdateHeading"
          v-text="$t('stanchionApp.district.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.district.name')" for="district-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
