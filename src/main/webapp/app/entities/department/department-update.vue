  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="stanchionApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="$t('stanchionApp.department.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.department.departmentName')" for="department-departmentName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.department.location')" for="department-location">Location</label>
