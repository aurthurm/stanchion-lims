  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="stanchionApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="$t('stanchionApp.jobHistory.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.jobHistory.startDate')" for="job-history-startDate"
              >Start Date</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.jobHistory.endDate')" for="job-history-endDate">End Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.jobHistory.language')" for="job-history-language">Language</label>
            <select
              class="form-control"
              name="language"
            ...
            >
              <option
                ...
                v-bind:label="$t('stanchionApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.jobHistory.job')" for="job-history-job">Job</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.jobHistory.department')" for="job-history-department"
              >Department</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('stanchionApp.jobHistory.employee')" for="job-history-employee">Employee</label>
