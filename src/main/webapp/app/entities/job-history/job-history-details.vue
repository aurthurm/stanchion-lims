    ...
    <div class="col-8">
      <div v-if="jobHistory">
        <h2 class="jh-entity-heading" data-cy="jobHistoryDetailsHeading">
          <span v-text="$t('stanchionApp.jobHistory.detail.title')">JobHistory</span> {{ jobHistory.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('stanchionApp.jobHistory.startDate')">Start Date</span>
          </dt>
          <dd>
            <span v-if="jobHistory.startDate">{{ $d(Date.parse(jobHistory.startDate), 'long') }}</span>
          </dd>
          <dt>
            <span v-text="$t('stanchionApp.jobHistory.endDate')">End Date</span>
          </dt>
          <dd>
            <span v-if="jobHistory.endDate">{{ $d(Date.parse(jobHistory.endDate), 'long') }}</span>
          </dd>
          <dt>
            <span v-text="$t('stanchionApp.jobHistory.language')">Language</span>
          </dt>
          <dd>
            <span v-text="$t('stanchionApp.Language.' + jobHistory.language)">{{ jobHistory.language }}</span>
          </dd>
          <dt>
            <span v-text="$t('stanchionApp.jobHistory.job')">Job</span>
          </dt>
          <dd>
          ...
          <dt>
            <span v-text="$t('stanchionApp.jobHistory.department')">Department</span>
          </dt>
          <dd>
          ...
          <dt>
            <span v-text="$t('stanchionApp.jobHistory.employee')">Employee</span>
          </dt>
          <dd>
