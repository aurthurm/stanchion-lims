package com.d3sage.stanchion.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.d3sage.stanchion.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.d3sage.stanchion.repository.UserRepository.USERS_BY_EMAIL_CACHE);
