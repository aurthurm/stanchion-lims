...
import com.d3sage.stanchion.repository.CountryRepository;
import com.d3sage.stanchion.service.CountryService;
...
/**
 * REST controller for managing {@link com.d3sage.stanchion.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    public List<CountryDTO> getAllCountries(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
