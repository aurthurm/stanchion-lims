...
/**
 * REST controller for managing {@link com.d3sage.stanchion.domain.Province}.
 */
@RestController
@RequestMapping("/api")
public class ProvinceResource {
    ...
    public List<ProvinceDTO> getAllProvinces(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
