...
import com.d3sage.stanchion.repository.LocationRepository;
import com.d3sage.stanchion.service.LocationService;
...
/**
 * REST controller for managing {@link com.d3sage.stanchion.domain.Location}.
 */
@RestController
@RequestMapping("/api")
